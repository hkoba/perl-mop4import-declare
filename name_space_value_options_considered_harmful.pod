...
Your colleagues uses this program B<A> almost everyday. Although they
...
specifications. But I don't know such implementation and even if there
is such thing, IMHO, it is too much for casual automation by
end-users.

Instead, I want is a Poorman's approach (or some kind of Zen).
